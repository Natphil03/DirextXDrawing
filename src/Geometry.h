...
Vertex verticesCube[] =
{
	...
	{ Vector4(+1.0f, -1.0f, -1.0f, 1.0f), Vector4(Colors::Orange) },
	{ Vector4(-1.0f, -1.0f, +1.0f, 1.0f), Vector4(Colors::Pink)   },
	{ Vector4(-1.0f, +1.0f, +1.0f, 1.0f), Vector4(Colors::Blue)   },
	{ Vector4(+1.0f, +1.0f, +1.0f, 1.0f), Vector4(Colors::Blue)   },
...
{
	{ Vector4(-1.0f, 0.0f, 1.0f, 1.0f), Vector4(Colors::Blue)    },
	{ Vector4(1.0f, 0.0f, 1.0f, 1.0f), Vector4(Colors::Red)      },
	{ Vector4(-1.0f, 0.0f, -1.0f, 1.0f), Vector4(Colors::Yellow) },
	{ Vector4(1.0f, 0.0f, -1.0f, 1.0f), Vector4(Colors::Pink)    },

	{ Vector4(0.0f, 3.0f, 0.0f, 1.0f), Vector4(Colors::Orange)   },
};
